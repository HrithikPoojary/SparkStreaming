class TestSuiteWindowTime:
    ...
    def cleanUp(self):
        ...
        self.spark.sql("create table if not exists kafka_bz4(key STRING , value STRING) using delta")
    ...
    def assertTradeSummary(self , start , end , expected_buy , expected_sell):
        ...
        df = self.spark.sql(f"""
                                select TotalBuy , TotalSell from trade_summary4
    ...
    def runTest(self):
        ...
        self.spark.sql("""INSERT INTO kafka_bz4 VALUES
