...
class TradeSummary:
    ...
    def readKafka(self):
        return (
            spark.readStream.table("kafka_bz4")
        )
    ...
    def getAggregate(self , trade_df):
        ...
        return (
                    trade_df.withWatermark(trade_df.CreatedTime , "30 minutes") # it will do clean up after 30 minutes 
                                .groupBy(window(trade_df.CreatedTime , "15 minutes"))       # gives structtype of timewindow like 0-15,15-30...
